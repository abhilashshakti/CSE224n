...
class ParserModel(Model):
    ...
    def add_embedding(self):
        ...
        # print('shape', embeddings.get_shape())
    ...
    def add_prediction_op(self):
        ...
        ### YOUR CODE HERE
        xav_init = xavier_weight_init()
        W = tf.Variable(xav_init((self.config.n_features*self.config.embed_size, self.config.hidden_size)))
        b1 = tf.Variable(tf.zeros((self.config.hidden_size,)))
        U = tf.Variable(xav_init((self.config.hidden_size, self.config.n_classes)))
